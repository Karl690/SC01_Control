...
//the array for holding the XY data, is 
...
void ui_plot_call_event_button(uint8_t code, bool direct)
{
	...
	case UI_PLOT_BTN_SCAN:
		communication_tx_commandline(MegComPort, "M801 I666 T0 C0\n");
		break;
	case UI_PLOT_BTN_STOP:
		communication_tx_commandline(MegComPort, "M801 I661 T255\n");
		break;
	...
	case UI_PLOT_BTN_SAVE:
		...
		case 0:communication_tx_commandline(MegComPort, "M801 I665 T0 C6\n"); break;
		case 6:communication_tx_commandline(MegComPort, "M801 I665 T6 C6\n"); break;
		case 12:communication_tx_commandline(MegComPort, "M801 I665 T12 C6\n"); break;
		case 18:communication_tx_commandline(MegComPort, "M801 I665 T18 C6\n"); break;
		case 24:communication_tx_commandline(MegComPort, "M801 I665 T24 C6\n"); break;
		case 30:communication_tx_commandline(MegComPort, "M801 I665 T30 C6\n"); break;
		default:communication_tx_commandline(MegComPort, "M801 I665 T0 C6\n"); break;
		}
		break;
...
void ui_plot_analyze()
{
	...
	for (int i = 0; i < UI_PLOT_CHANNEL_NUM; i++)
	{
		...
		ui_textarea_set_nmuber(ui_plot_obj.txt_ch[i], (ui_plot_info.channel_peaks[i].x-10));
	}
	if (max_y >= 1000)
	{
