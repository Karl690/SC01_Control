...
#define SERIAL_UART1_TXD_PIN	(GPIO_NUM_1)//(GPIO_NUM_12)  //GPIO_NUM_21 is for lvana
#define SERIAL_UART1_RXD_PIN	(GPIO_NUM_2)//(GPIO_NUM_14)   //GPIO_NUM_44= U0RXD //GPIO_NUM_21
