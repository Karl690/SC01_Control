	...
	case S1F5:
		{
			...
			if (channel < MAX_CHANNELS)
			{
				...
				communication_add_string_to_serial_buffer(&MegComPort->TxBuffer, temp_string);
	...
	case S2F21: 
		{
			...
			case 0x1B: //Cancel Process
				communication_add_string_to_serial_buffer(&MegComPort->TxBuffer, "M801 I661 T255\n"); 
				break;
			case 1: //START PROCESS
				communication_add_string_to_serial_buffer(&MegComPort->TxBuffer, "M801 I660 T255\n"); 
				break;
