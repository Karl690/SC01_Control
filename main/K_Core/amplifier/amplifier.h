...
extern uint16_t AmpBaseAddress ;
extern uint16_t ProcessTimer ;
extern uint16_t TotalPower ;
extern uint16_t Rf_Power_Ch1 ;
extern uint16_t Rf_Power_Ch2 ;
extern uint16_t Rf_Power_Ch3 ;
extern uint16_t Rf_Power_Ch4 ;
extern uint16_t Rf_Power_Ch5 ;
extern uint16_t Rf_Power_Ch6 ;
extern uint16_t ArrayPluggedIn ;

extern uint16_t amplifier_processmode; //0: Process, 1: Programming mode
extern uint8_t amplifier_logging[MAX_CHANNELS];
extern char amplifier_major_step[10];
extern uint8_t amplifier_channel_index;
